...
QT_MOC_LITERAL(1, 6, 10), // "polishlett"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 8), // "QString*"
QT_MOC_LITERAL(4, 27, 4), // "lett"
QT_MOC_LITERAL(5, 32, 4), // "size"
QT_MOC_LITERAL(6, 37, 6) // "polish"

    },
    "Board\0polishlett\0\0QString*\0lett\0size\0"
    "polish"
};
...
void Board::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->polishlett((*reinterpret_cast< QString*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Board::*)(QString * , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Board::polishlett)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Board::polishlett(QString * _t1, int _t2)
{
